...
public class UserDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        uList.setAutoCreateRowSorter(true);
        uList.setBackground(new java.awt.Color(248, 148, 6));
        uList.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        uList.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null}
            },
            new String [] {
                "Username", "Mobile No", "NIC", "Email"
            }
        ));
        uList.setToolTipText("");
        ...
        adList.setAutoCreateRowSorter(true);
        adList.setBackground(new java.awt.Color(248, 148, 6));
        adList.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        adList.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null}
            },
            new String [] {
                "Admin Name", "Mobile No", "NIC", "Email"
            }
        ));
        adList.setToolTipText("");
        jScrollPane2.setViewportView(adList);
    ...
    private void refreshActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_refreshActionPerformed
        ...
        DefaultTableModel dtm = (DefaultTableModel) uList.getModel();
        DefaultTableModel dtm1 = (DefaultTableModel) adList.getModel();

        try {
            ResultSet result = new DBSearch().UserDetails();

            while(result.next()){
                uName = result.getString("firstName");
                mobNo = result.getString("mobNo");
                nic = result.getString("nic");
                email = result.getString("email");
                typeOfUser = result.getString("typeOfUser");

                if ("User".equals(typeOfUser)){
                    String trData[] = {uName, mobNo, nic, email};
                    dtm.addRow(trData);
                }
                else {
                    String trData[] = {uName, mobNo, nic, email};
